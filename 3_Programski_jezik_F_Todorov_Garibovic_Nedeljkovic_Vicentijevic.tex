...
Neke od osnovnih osobina programskog jezika F\# su:\\
	...
	- \textbf{Kompatibilan}: F\# programi mogu da pozivaju i da budu pozvani iz drugih programa koji su napisani na nekom od jezika koje podržava .NET platforma. Jedan od primera je C\# ,ali i mnogi drugi. %dodati referencu na official-page C#
\\
%Nešto više o njima\cite{Harrop:2008:FS:1481410}.
	...
	- Pored uobičajenih tipova podataka podržanih u većini programskih jezika, F\# podržava novi tip \textbf{option type}, koji označava vrednost promenljive koja može da postoji a i ne mora. Dve moguće vrednosti ovog tipa su: Some(x) i None. %ova dva bih iskosila - Tamara
...
%iskosila bihČ APM, BeginOperation, EndOperation
...
%referenca za parallel extension
